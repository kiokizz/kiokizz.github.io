...
|Win Ratio (Win/Loss+Draw)|${(report_array.matches.wins / report_array.matches.loss).toFixed(2)} (${report_array.matches.wins}/${report_array.matches.loss}/${report_array.matches.draws})|
